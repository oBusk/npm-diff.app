...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/hooks/useMinCollapsedLines.js Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/hooks/useChangeSelect.js Source}) */
export declare const useChangeSelect: (
    hunks: HunkData[],
    options: UseChangeSelectOptions,
) => [string[], (dispatch: { change: Change }) => void];

/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/hooks/useSourceExpansion.js Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/hooks/useTokenizeWorker.js Source}) */
