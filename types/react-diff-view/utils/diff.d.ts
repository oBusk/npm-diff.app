...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/insertHunk.js#L164-L184 Source}) */
export declare const insertHunk: (
    hunks: HunkData[],
    insertion: HunkData,
) => HunkData[];

/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/expandCollapsedBlockBy.js#L124-L142 Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/expandCollapsedBlockBy.js#L144-L157 Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/expandCollapsedBlockBy.js#L159-L185 Source}) */
...
/** {@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/getChangeKey.js#L1-L15 Source}) */
export declare const getChangeKey: (change: Change) => number;

/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/factory.js#L13-L14 Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/factory.js#L5 Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/factory.js#L44-L57 Source}) */
...
/** ({@link https://github.dev/otakustay/react-diff-view/blob/v2.4.10/src/utils/diff/factory.js#L70-L131 Source}) */
